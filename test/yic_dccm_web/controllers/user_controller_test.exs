defmodule YicDccmWeb.UserControllerTest do
  use YicDccmWeb.ConnCase

  alias YicDccm.Accounts

  @create_attrs %{email: "some email", first_name: "some first_name", infix: "some infix", last_name: "some last_name", login: "some login", password_hash: "some password_hash", status: "some status"}
