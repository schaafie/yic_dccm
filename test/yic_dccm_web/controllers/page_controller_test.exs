defmodule YicDccmWeb.PageControllerTest do
  use YicDccmWeb.ConnCase

  alias YicDccm.SiteManager

  @create_attrs %{body: "some body", footer: "some footer", header: "some header", location: "some location", title: "some title"}
  ...
  def fixture(:page) do
    {:ok, page} = SiteManager.create_page(@create_attrs)
    page
  end
